// --- Kolibri & Qualle Game mit Timer, Score, mehr Platz, leichter Kolibri ---
...
function resetGame() {
  if (gameMode === "kolibri") {
    ...
    gravity = 0.23; // weniger Gravitation -> mehr gleiten
    jumpStrength = -6.3;
    obstacleSpeed = 3.5;
    backgroundAnim = 0;
    obstacles = [];
